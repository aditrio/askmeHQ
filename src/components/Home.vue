    ...
    <v-container>
        <v-row class="mt-5">
            <v-col align="center">
                ...
                <p>Membantumu menemukan apa yang kamu cari <br> ( Hadits & Al-Quran )</p>
            </v-col>
            ...
            <v-col cols="10">
                ...
                <br>
                 <v-tabs-items v-model="tab" style="border-top: #4A148C 2px solid;">
                    ...
                    >
                        ...
                        <v-expansion-panels inset >
                            ...
                            >   
                                ...
                                <v-expansion-panel-content style="border-left: #4A148C 1px solid">
                                    <p>No Hadits: </p>
                                    <v-chip-group
                    ...
                    >
                        <v-card flat>
                            <v-card-text align="center">kalau Al-Quran nya ada disini</v-card-text>
                        </v-card>
                    </v-tab-item>
                     <v-tab-item  
                        value="lainnya"                    
                    >
                        <v-card flat>
                            <v-card-text align="center">Referensi tambahan bisa aja ada disini</v-card-text>
                        </v-card>
                    </v-tab-item>
                </v-tabs-items>
